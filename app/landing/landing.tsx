        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { icon: "📄", title: "Invoice QR (Reference)", desc: "Reference QR code on every PDF — useful for B2B invoices without claiming IRP registration" },
