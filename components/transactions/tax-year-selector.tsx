...
interface TaxYearSelectorProps {
  taxYearStart: string // Format: "MM-DD", e.g., "04-01" for India
 ...
 * Tax years are displayed as "2023-2024" format for fiscal years,
 * or "2024" for calendar years (Jan 1 start).
 */
export function TaxYearSelector({ taxYearStart, value, onChange }: TaxYearSelectorProps) {
  ...
  // Generate tax years from 10 years ago to current year + 1
  const taxYears = useMemo(() => {
    ...
    for (let year = currentYear + 1; year >= currentYear - 10; year--) {
      if (isCalendarYear) {
        ...
        // Fiscal year: e.g., Apr 1, 2024 to Mar 31, 2025 shown as "2024-2025"
